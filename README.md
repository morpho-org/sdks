...
- [**`@morpho-org/evm-simulation`**](./packages/evm-simulation/): EVM simulation engine for Morpho transactions, using `eth_simulateV1`, signature authorization handling, and bundle-periphery retention checks
