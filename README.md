...
- [**`@morpho-org/midnight-sdk`**](./packages/midnight-sdk/): Framework-agnostic protocol utilities for Morpho Midnight, including ABI literals, market and offer helpers, fetch helpers, and Midnight API validation utilities
