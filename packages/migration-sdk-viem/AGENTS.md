...
- `config.ts` is the owner of migration adapter addresses.
- Position classes expose validated `getMigrationTx(...)` and keep protocol-specific calldata/signature encoding in subclasses.
