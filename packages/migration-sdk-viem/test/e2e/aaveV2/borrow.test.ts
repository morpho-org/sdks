...
describe("Borrow position on AAVE V2", () => {
  ...
  const aWstEth: Address = "0x0B925eD163218f6662a35e0f0371Ac234f9E9371";
  const variableDebtToken: Address =
    "0xeA51d7853EEFb32b6ee06b1C12E6dcCA88Be0fFE";
  const testFn = test[ChainId.EthMainnet] as TestAPI<ViemTestContext>;
  const marketTo = markets[ChainId.EthMainnet].eth_wstEth_2;

  const { lendingPool } = MIGRATION_ADDRESSES[chainId].aaveV2!;
  const {
    bundler3: { generalAdapter1, aaveV2CoreMigrationAdapter },
    wNative,
    usdc,
    wstEth,
    morpho,
  ...
  describe(`on chain ${chainId}`, () => {
    ...
    testFn("should partially migrate user position", async ({ client }) => {
          ...
          args: [
            ...
            [
              ...
              },
              {
                ...
                args: [aWstEth, migratedCollateral, aaveV2CoreMigrationAdapter],
              },
              {
                type: "aaveV2Withdraw",
      ...
      const adapters = [generalAdapter1, aaveV2CoreMigrationAdapter];
        ...
        },
        {
          args: [
            ...
            [
              ...
              {
                type: "erc20TransferFrom",
                args: [aWstEth, maxUint256, aaveV2CoreMigrationAdapter],
              },
              {
                type: "aaveV2Withdraw",
          ...
          },
          {
            args: [
              ...
              [
                ...
                {
                  type: "erc20TransferFrom",
                  args: [aWstEth, liquidity, aaveV2CoreMigrationAdapter],
                },
                {
                  type: "aaveV2Withdraw",
