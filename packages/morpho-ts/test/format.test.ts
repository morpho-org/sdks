...
import { createFormat, Format, format } from "../src";
  ...
  describe("number", () => {
    ...
    describe("should properly format bigint in number format", () => {
      ...
      test("without trailing zeros", () => {
        ...
        expect(
          format.number.digits(6).trailingZero(true).of(bigint, decimals),
        ).toEqual("12345.678900");
      });
  ...
  describe("short", () => {
    ...
    describe("should properly format bigint in short format", () => {
      ...
      test("without trailing zeros", () => {
        ...
        expect(
          format.short.digits(8).trailingZero(true).of(bigint, decimals),
        ).toEqual("12.34567890k");
      });
  ...
  describe("commas", () => {
    ...
    describe("should properly format bigint in commas format", () => {
      ...
      test("without trailing zeros", () => {
        ...
        expect(
          format.commas.digits(6).trailingZero(true).of(bigint, decimals),
        ).toEqual("12,345.678900");
      });
