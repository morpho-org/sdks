...
const _addressesRegistry = {
  ...
  [ChainId.FraxtalMainnet]: {
    ...
    morphoMarketV1AdapterV2Factory: "0xa036C78AE8e162feD4db4abbD41f79995F28bC4b",
  ...
  [ChainId.ScrollMainnet]: {
    ...
    morphoMarketV1AdapterV2Factory: "0x3199Ddb2aA394B175a814EB79BB654822Ee1100F",
  ...
  [ChainId.InkMainnet]: {
    ...
    morphoMarketV1AdapterV2Factory: "0x92A070b2b4Af436ba4a168451fb360e45b849355",
  ...
  [ChainId.SonicMainnet]: {
    ...
    morphoMarketV1AdapterV2Factory: "0xc49224e28992E693aFaa778a6F54c329E5Ac9704",
  ...
  [ChainId.HemiMainnet]: {
    ...
    morphoMarketV1AdapterV2Factory: "0x0d9E428075b8A691e12237984b8284E40ab9363A",
  ...
  [ChainId.ModeMainnet]: {
    ...
    morphoMarketV1AdapterV2Factory: "0x97CF0f15bf580838900161F2a4D7CE9BC88E8d5D",
  ...
  [ChainId.EtherlinkMainnet]: {
    ...
    morphoMarketV1AdapterV2Factory: "0x588737013F0302a2fa82Dc03DA06126a81B8be45",
  ...
  [ChainId.TacMainnet]: {
    ...
    morphoMarketV1AdapterV2Factory: "0xabA00365C6284548F90480993fc46dbB7775FB96",
  ...
  [ChainId.LiskMainnet]: {
    ...
    morphoMarketV1AdapterV2Factory: "0x382d00918B744Bd91B906f38CAe54e67649E770C",
  ...
  [ChainId.SeiMainnet]: {
    ...
    morphoMarketV1AdapterV2Factory: "0xbADd49F7db90f65fF5822681AA6B8548E8356a1D",
  ...
  [ChainId.ZeroGMainnet]: {
    ...
    morphoMarketV1AdapterV2Factory: "0x2614BAEA6aE12117565668720aD92ca0149aBA03",
  ...
  [ChainId.LineaMainnet]: {
    ...
    morphoMarketV1AdapterV2Factory: "0xcAB7C66F7191Ad3Ef1e7fEeb67F3137BC975F8cE",
  ...
  [ChainId.CeloMainnet]: {
    ...
    morphoMarketV1AdapterV2Factory: "0x8F5C08671A3986b2B0261FF78f5c2F291208BceC",
  ...
  [ChainId.AbstractMainnet]: {
    ...
    morphoMarketV1AdapterV2Factory: "0xAA2D848d759d872A45e5658B55B02e589101D9C0",
  ...
  [ChainId.BitlayerMainnet]: {
    ...
    morphoMarketV1AdapterV2Factory: "0x626f8ea9b3B70C03F8cf9a29eFBb9F3b093d1599",
  ...
  [ChainId.BscMainnet]: {
    ...
    morphoMarketV1AdapterV2Factory: "0x18c1b03ac8007224FE86442a91fEE3135ba767CD",
  ...
  [ChainId.SoneiumMainnet]: {
    ...
    morphoMarketV1AdapterV2Factory: "0xd25Ae31a2480DF33b7E5F8CfEE4229248309d519",
...
const withAliases = <
  T extends {
    blue?: unknown;
    morpho?: unknown;
    vaultV1PublicAllocator?: unknown;
    publicAllocator?: unknown;
  },
>({
  entry,
  label,
  ...
  if (
    entry.vaultV1PublicAllocator != null &&
    entry.publicAllocator != null &&
    !areRegistryValuesEqual({
      base: entry.vaultV1PublicAllocator,
      patch: entry.publicAllocator,
      type,
    })
  )
    throw new RegistryValueAlreadyRegisteredError({
      label: `${label}.publicAllocator`,
      registeredValue: isRegistryPrimitive(entry.vaultV1PublicAllocator)
        ? entry.vaultV1PublicAllocator
        : String(entry.vaultV1PublicAllocator),
      requestedValue: isRegistryPrimitive(entry.publicAllocator)
        ? entry.publicAllocator
        : String(entry.publicAllocator),
      type,
    });

  return {
    ...entry,
    ...(entry.blue != null || entry.morpho != null
      ? {
          blue: entry.blue ?? entry.morpho,
          morpho: entry.morpho ?? entry.blue,
        }
      : {}),
    ...(entry.vaultV1PublicAllocator != null || entry.publicAllocator != null
      ? {
          vaultV1PublicAllocator:
            entry.vaultV1PublicAllocator ?? entry.publicAllocator,
          publicAllocator:
            entry.publicAllocator ?? entry.vaultV1PublicAllocator,
        }
      : {}),
  } as T;
};
