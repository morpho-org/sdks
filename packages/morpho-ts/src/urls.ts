...
export const getSubdomainBaseUrl = (subDomain: string) => `https://${subDomain}.${MORPHO_DOMAIN}`;
...
export const BLUE_API_GRAPHQL_URL = new URL("/graphql", BLUE_API_BASE_URL).toString();
