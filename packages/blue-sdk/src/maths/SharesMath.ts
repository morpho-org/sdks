...
export namespace SharesMath {
  ...
  export function toAssets(
    ...
    return MathLib.mulDiv(shares, BigInt(totalAssets) + VIRTUAL_ASSETS, BigInt(totalShares) + VIRTUAL_SHARES, rounding);
  }
  ...
  export function toShares(
    ...
    return MathLib.mulDiv(assets, BigInt(totalShares) + VIRTUAL_SHARES, BigInt(totalAssets) + VIRTUAL_ASSETS, rounding);
  }
}
