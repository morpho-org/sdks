 ...
 */
export const unwrappedTokensMapping: Record<ChainId, Record<Address, Address>> = {
  [ChainId.EthGoerliTestnet]: {
    [addresses[ChainId.EthGoerliTestnet].wNative]: NATIVE_ADDRESS,
    [addresses[ChainId.EthGoerliTestnet].wstEth]: addresses[ChainId.EthGoerliTestnet].stEth,
  },
  [ChainId.EthMainnet]: {
...
export const permissionedBackedTokens: Record<ChainId, Set<Address>> = {
  [ChainId.EthMainnet]: new Set([addresses[ChainId.EthMainnet].wbIB01, addresses[ChainId.EthMainnet].wbC3M]),
  [ChainId.EthGoerliTestnet]: new Set(),
  [ChainId.BaseMainnet]: new Set(),
};
