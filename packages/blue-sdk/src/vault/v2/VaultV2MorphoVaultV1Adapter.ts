  ...
  implements IAccrualVaultV2MorphoVaultV1Adapter, IAccrualVaultV2Adapter
{
   ...
   * Vault V1 shares transferred directly to it. Zero shares also skip projection.
   * An undefined `parentAllocation` preserves legacy
  ...
  realAssets(timestamp?: BigIntish) {
    if (this.parentAllocation === 0n || this.shares === 0n) return 0n;
