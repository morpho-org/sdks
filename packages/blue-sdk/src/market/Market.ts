...
export class Market implements InputMarket {
   ...
   */
  get isIdle() {
    return this.config.collateralToken === "0x0000000000000000000000000000000000000000";
  }
  ...
  public accrueInterest(timestamp: BigIntish) {
    ...
    if (elapsed < 0n) throw new BlueErrors.InvalidInterestAccrual(this.id, timestamp, this.lastUpdate);
    ...
    if (this.rateAtTarget != null) {
      const { avgBorrowRate, endRateAtTarget } = AdaptiveCurveIrmLib.getBorrowRate(
        this.utilization,
        this.rateAtTarget,
        elapsed
      );
  ...
  public supply(assets: bigint, shares: bigint, timestamp: bigint = this.lastUpdate) {
  ...
  public withdraw(assets: bigint, shares: bigint, timestamp: bigint = this.lastUpdate) {
    if (assets === 0n && shares === 0n) throw new BlueErrors.InconsistentInput();
    ...
    if (market.totalBorrowAssets > market.totalSupplyAssets) throw new BlueErrors.InsufficientLiquidity(market.id);

    return { market, assets, shares };
  }

  public borrow(assets: bigint, shares: bigint, timestamp: bigint = this.lastUpdate) {
    if (assets === 0n && shares === 0n) throw new BlueErrors.InconsistentInput();
  ...
  public repay(assets: bigint, shares: bigint, timestamp: bigint = this.lastUpdate) {
    if (assets === 0n && shares === 0n) throw new BlueErrors.InconsistentInput();
   ...
   */
  public getMaxBorrowableAssets(position: { collateral: bigint; borrowShares: bigint }) {
   ...
   * @param position The borrow position to consider.
   */
  public getSeizableCollateral(position: { collateral: bigint; borrowShares: bigint }) {
   ...
   * @param position The borrow position to consider.
   */
  public getWithdrawableCollateral(position: { collateral: bigint; borrowShares: bigint }) {
   ...
   * @param position The borrow position to consider.
   */
  public getLiquidationPrice(position: { collateral: bigint; borrowShares: bigint }) {
   ...
   * @param position The borrow position to consider.
   */
  public getPriceVariationToLiquidation(position: { collateral: bigint; borrowShares: bigint }) {
    return MarketUtils.getPriceVariationToLiquidation(position, this, this.config);
  }
   ...
   * @param position The borrow position to consider.
   */
  public getHealthFactor(position: { collateral: bigint; borrowShares: bigint }) {
   ...
   * @param position The borrow position to consider.
   */
  public getBorrowCapacityUsage(position: { collateral: bigint; borrowShares: bigint }) {
   ...
   * @param position The borrow position to consider.
   */
  public getRepayCapacityLimit(borrowShares: bigint, loanTokenBalance: bigint): CapacityLimit {
   ...
   */
  public getWithdrawCapacityLimit({ supplyShares }: { supplyShares: bigint }): CapacityLimit {
   ...
   * @param position The borrow position to consider.
   */
  public getWithdrawCollateralCapacityLimit(position: { collateral: bigint; borrowShares: bigint }): CapacityLimit {
