import { ChainId, Token, Address, addresses, getChainAddresses } from "@morpho-org/blue-sdk";
...
export const WITH_SIMPLE_PERMIT: {
  ...
  [ChainId.BaseMainnet]: [addresses[ChainId.BaseMainnet].usdc, addresses[ChainId.BaseMainnet].verUsdc],
};

export const hasSimplePermit = (chainId: ChainId, address: Address) => WITH_SIMPLE_PERMIT[chainId]?.includes(address);
