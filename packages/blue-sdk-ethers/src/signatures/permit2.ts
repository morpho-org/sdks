import { ChainId, MathLib, Address, getChainAddresses } from "@morpho-org/blue-sdk";
...
export const getPermit2TransferFromMessage = (args: Permit2TransferFromArgs, chainId: ChainId) => {
  const domain = {
    name: "Permit2",
...
export const getPermit2Message = (args: Permit2Args, chainId: ChainId): SignatureMessage => {
  const domain = {
    name: "Permit2",
    chainId: chainId.toString(),
    verifyingContract: getChainAddresses(chainId).permit2,
