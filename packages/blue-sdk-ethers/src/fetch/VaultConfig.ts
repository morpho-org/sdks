...
import { ChainId, ChainUtils, UnknownVaultConfigError, VaultConfig, _try, Address } from "@morpho-org/blue-sdk";
...
export async function fetchVaultConfig(
  ...
  let config = _try(() => VaultConfig.get(address, chainId), UnknownVaultConfigError);
