...
export namespace BundlerAction {
   ...
   * @param slippageAmount The maximum amount of assets supplied per minted share, scaled by 1e27.
   ...
   * @param slippageAmount The minimum amount of assets borrowed per borrow share minted, scaled by 1e27.
   ...
   * @param slippageAmount The maximum amount of assets repaid per redeem share, scaled by 1e27.
   ...
   * @param slippageAmount The minimum amount of assets withdrawn per redeem share, scaled by 1e27.
