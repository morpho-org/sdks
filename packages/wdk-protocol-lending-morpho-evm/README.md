...
- BlueBundlesV1 calls use a two-hour deadline; signed calls reuse the requirement signature's deadline as long as it is within two hours of submission — a longer deadline throws `BlueBundlesV1DeadlineExceedsWindowError`.
