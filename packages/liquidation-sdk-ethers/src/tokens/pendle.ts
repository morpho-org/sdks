...
export namespace Pendle {
  ...
  export const getRedeemApiPath = (chainId: BigNumberish) =>
    `v1/sdk/${chainId}/redeem`;
  export const getTokensApiPath = (chainId: BigNumberish) =>
    `v1/${chainId}/assets/pendle-token/list`;
  export const getMarketsApiPath = (chainId: BigNumberish) =>
    `v1/${chainId}/markets`;

  export const getSwapApiUrl = (chainId: BigNumberish) =>
    new URL(getSwapApiPath(chainId), API_URL).toString();
  export const getRedeemApiUrl = (chainId: BigNumberish) =>
    new URL(getRedeemApiPath(chainId), API_URL).toString();
  export const getTokensApiUrl = (chainId: BigNumberish) =>
    new URL(getTokensApiPath(chainId), API_URL).toString();
  export const getMarketsApiUrl = (chainId: BigNumberish) =>
