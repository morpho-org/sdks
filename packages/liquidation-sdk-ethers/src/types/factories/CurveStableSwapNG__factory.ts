...
export class CurveStableSwapNG__factory {
  static readonly abi = _abi;
  static createInterface(): CurveStableSwapNGInterface {
    return new Interface(_abi) as CurveStableSwapNGInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): CurveStableSwapNG {
    return new Contract(address, _abi, runner) as unknown as CurveStableSwapNG;
  }
}
