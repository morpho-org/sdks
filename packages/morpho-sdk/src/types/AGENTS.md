...
- `DepositAmountArgs` — union enforcing at least one of `amount` / `nativeAmount`. Used by vault
  deposits. Direct BlueBundlesV1 native funding is exclusive with ERC-20 funding rather than
  additive.
