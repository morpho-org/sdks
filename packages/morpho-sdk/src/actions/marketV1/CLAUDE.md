...
MarketV1 (Morpho Blue) transaction builders. Inherits all rules from [`actions/CLAUDE.md`](../CLAUDE.md) and [`packages/morpho-sdk/CLAUDE.md`](../../../CLAUDE.md).
...
Enforced by the entity layer's `getRequirements`; see [`entities/marketV1/CLAUDE.md`](../../entities/marketV1/CLAUDE.md):
...
Reallocation rules: see [`actions/CLAUDE.md`](../CLAUDE.md#shared-liquidity--reallocations-canonical-statement) for the canonical contract.
