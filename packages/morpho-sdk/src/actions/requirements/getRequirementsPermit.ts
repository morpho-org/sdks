 ...
 * `amount`.
 *
 * @param viemClient - Connected `PublicClient` (used by `encodeErc20Permit` for `fetchToken`). Signing happens via the returned `Requirement.sign(walletClient, userAddress)`.
