 ...
 * @param params.vault.address - Vault V2 contract receiving the net deposit.
 ...
 * @returns A deep-frozen `Transaction<VaultV2DepositAction>` targeting VaultBundlesV1, with
 ...
 *
 * export function buildKeyrockUsdcDeposit(
 *   userAddress: Address,
 *   maxSharePrice: bigint,
 *   deadline: bigint,
 * ) {
 *   const keyrockUsdcVaultV2 = "0x04422053aDDbc9bB2759b248B574e3FCA76Bc145";
 *   const { usdc } = getChainAddresses(mainnet.id);
 *   const tx = vaultV2Deposit({
 *     vault: { chainId: mainnet.id, address: keyrockUsdcVaultV2, asset: usdc! },
