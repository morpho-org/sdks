...
Pure protocol-specific utilities shared across layers. They return new objects and never mutate inputs. Inherits [`packages/morpho-sdk/CLAUDE.md`](../../CLAUDE.md).
