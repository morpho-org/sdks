...
- **Shared-liquidity** — Vault V2 planning and state transitions live on
  ...
  high-level Blue writes. Vault V1 planning, validation, and low-level composition helpers were
  removed in v6. Read-only liquidity metrics live on the Vault V2 reallocation-data entity, not in
  this layer.
