...
export {
  ...
  OFFER_TYPEHASH,
  PRICE_RATIFIER_V1_OFFER_TYPEHASH as MIDNIGHT_PRICE_RATIFIER_V1_OFFER_TYPEHASH,
  /** @deprecated Use `MIDNIGHT_PRICE_RATIFIER_V1_OFFER_TYPEHASH` or the raw `/midnight/constants` subpath. */
  ...
  PRICE_ROUNDING_STEP,
  RATE_RATIFIER_V1_OFFER_TYPEHASH as MIDNIGHT_RATE_RATIFIER_V1_OFFER_TYPEHASH,
  /** @deprecated Use `MIDNIGHT_RATE_RATIFIER_V1_OFFER_TYPEHASH` or the raw `/midnight/constants` subpath. */
