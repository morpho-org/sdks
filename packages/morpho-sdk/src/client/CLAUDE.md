...
Entry point of the SDK. `MorphoClient` wraps a viem `Client` and exposes vault/market accessors. Inherits the rules in [`packages/morpho-sdk/CLAUDE.md`](../../CLAUDE.md).
