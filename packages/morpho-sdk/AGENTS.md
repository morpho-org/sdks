...
- **Blue reallocation migration** — Vault V1 inputs to high-level Blue writes are deprecated. Use
  `VaultV2BlueReallocation` for new write integrations; V1 planning and low-level Bundler3
