...
export const CbbtcUsdcBlue = new MarketParams({
...
/** Second cbBTC/USDC market: same tokens as {@link CbbtcUsdcBlue}, different oracle. Refinance destination. */
export const CbbtcUsdcBlueAlt = new MarketParams({
  collateralToken: "0xcbB7C0000aB88B473b1f5aFd9ef808440eed33Bf",
  loanToken: "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48",
...
export const WethUsdsBlue = new MarketParams({
...
export const UsdcEurcvBlue = new MarketParams({
...
export const WstethWethBlue = new MarketParams({
