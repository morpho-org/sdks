...
_Migrated from TIB-2026-08-18-vault-v2-blue-reallocation-api. Historical record: its implementation-time sections and instructions are kept as written; only the Status row is maintained._
