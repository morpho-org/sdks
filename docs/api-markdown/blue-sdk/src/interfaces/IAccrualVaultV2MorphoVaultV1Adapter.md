...
[@morpho-org/sdks](../../../README.md) / [blue-sdk/src](../README.md) / IAccrualVaultV2MorphoVaultV1Adapter

# Interface: IAccrualVaultV2MorphoVaultV1Adapter

Defined in: [packages/blue-sdk/src/vault/v2/VaultV2MorphoVaultV1Adapter.ts:97](https://github.com/morpho-org/sdks/blob/000d92bc88f6b9370d16dcc3069ffd81fbd85fe8/packages/blue-sdk/src/vault/v2/VaultV2MorphoVaultV1Adapter.ts#L97)

Plain input shape for an accrued Vault V2 MetaMorpho V1 adapter.

## Extends

- [`IVaultV2MorphoVaultV1Adapter`](IVaultV2MorphoVaultV1Adapter.md)
...
[`IVaultV2MorphoVaultV1Adapter`](IVaultV2MorphoVaultV1Adapter.md).[`morphoVaultV1`](IVaultV2MorphoVaultV1Adapter.md#morphovaultv1)
...
[`IVaultV2MorphoVaultV1Adapter`](IVaultV2MorphoVaultV1Adapter.md).[`type`](IVaultV2MorphoVaultV1Adapter.md#type)
