...
[@morpho-org/sdks](../../../README.md) / [blue-sdk/src](../README.md) / IAccrualVault

# Interface: IAccrualVault

Defined in: [packages/blue-sdk/src/vault/Vault.ts:205](https://github.com/morpho-org/sdks/blob/000d92bc88f6b9370d16dcc3069ffd81fbd85fe8/packages/blue-sdk/src/vault/Vault.ts#L205)

Plain input shape for a MetaMorpho vault paired with accrued market allocations.

## Extends

- `Omit`\<[`IVault`](IVault.md), `"withdrawQueue"` \| `"totalAssets"`\>
...
[`IVault`](IVault.md).[`asset`](IVault.md#asset)
...
[`IVault`](IVault.md).[`curator`](IVault.md#curator)
...
[`IVault`](IVault.md).[`decimalsOffset`](IVault.md#decimalsoffset)
...
[`IVault`](IVault.md).[`fee`](IVault.md#fee)
...
[`IVault`](IVault.md).[`feeRecipient`](IVault.md#feerecipient)
...
[`IVault`](IVault.md).[`guardian`](IVault.md#guardian)
...
[`IVault`](IVault.md).[`lastTotalAssets`](IVault.md#lasttotalassets)
...
[`IVault`](IVault.md).[`lostAssets`](IVault.md#lostassets)
...
[`IVault`](IVault.md).[`owner`](IVault.md#owner)
...
[`IVault`](IVault.md).[`pendingGuardian`](IVault.md#pendingguardian)
...
[`IVault`](IVault.md).[`pendingOwner`](IVault.md#pendingowner)
...
[`IVault`](IVault.md).[`pendingTimelock`](IVault.md#pendingtimelock)
...
[`IVault`](IVault.md).[`publicAllocatorConfig`](IVault.md#publicallocatorconfig)
...
[`IVault`](IVault.md).[`skimRecipient`](IVault.md#skimrecipient)
...
[`IVault`](IVault.md).[`supplyQueue`](IVault.md#supplyqueue)
...
[`IVault`](IVault.md).[`timelock`](IVault.md#timelock)
...
[`IVault`](IVault.md).[`totalSupply`](IVault.md#totalsupply)
