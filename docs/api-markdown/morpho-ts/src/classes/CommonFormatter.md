...
[@morpho-org/sdks](../../../README.md) / [morpho-ts/src](../README.md) / CommonFormatter

# Abstract Class: CommonFormatter

Defined in: [packages/morpho-ts/src/format/format/format.ts:439](https://github.com/morpho-org/sdks/blob/000d92bc88f6b9370d16dcc3069ffd81fbd85fe8/packages/morpho-ts/src/format/format/format.ts#L439)
...
- [`CommasFormatter`](CommasFormatter.md)
- [`ShortFormatter`](ShortFormatter.md)
- [`PercentFormatter`](PercentFormatter.md)

## Constructors

### Constructor

> **new CommonFormatter**(): `CommonFormatter`
...
> `abstract` `protected` **\_options**: `Readonly`\<`BaseFormatOptions`\>

Defined in: [packages/morpho-ts/src/format/format/format.ts:440](https://github.com/morpho-org/sdks/blob/000d92bc88f6b9370d16dcc3069ffd81fbd85fe8/packages/morpho-ts/src/format/format/format.ts#L440)
...
> `abstract` `protected` **\_clone**(`_options`): `this`

Defined in: [packages/morpho-ts/src/format/format/format.ts:295](https://github.com/morpho-org/sdks/blob/000d92bc88f6b9370d16dcc3069ffd81fbd85fe8/packages/morpho-ts/src/format/format/format.ts#L295)
...
> **default**(`_d`): `FormatterWithDefault`\<`CommonFormatter`\>
...
`FormatterWithDefault`\<`CommonFormatter`\>
...
> **trailingZero**(`enable?`): `CommonFormatter`
