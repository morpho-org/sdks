...
[@morpho-org/sdks](../../../README.md) / [morpho-sdk/src](../README.md) / ERC20PermitAction

# Interface: ERC20PermitAction

Defined in: [packages/morpho-sdk/src/types/action.ts:20](https://github.com/morpho-org/sdks/blob/000d92bc88f6b9370d16dcc3069ffd81fbd85fe8/packages/morpho-sdk/src/types/action.ts#L20)

## Properties

### sign

> **sign**: (`client`, `userAddress`) => `Promise`\<`` `0x${string}` ``\>

Defined in: [packages/morpho-sdk/src/types/action.ts:21](https://github.com/morpho-org/sdks/blob/000d92bc88f6b9370d16dcc3069ffd81fbd85fe8/packages/morpho-sdk/src/types/action.ts#L21)
