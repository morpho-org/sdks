...
| **Technical Project Plan** | Linear — the project description                          | Technical Project Plan Template (Notion)                      |
| **Implementation tickets** | Linear — one ticket per PR, flowing from the plan         | —                                                             |
| **Retrospective**          | Linear — the project's final update                       | —                                                             |
| **TIB** (retired)          | This repo — `docs/tibs/`, frozen records, no new ones     | none; see [ADR-2026-09-23](./adrs/ADR-2026-09-23-adr-structure.md) |
