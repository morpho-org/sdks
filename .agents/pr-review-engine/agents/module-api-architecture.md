...
- **Critical** — an entity flow whose `buildTx` reads state written by `getRequirements()`/`sign()` (hard gate, see `TIB-2026-09-23-stateless-entity-flows`).
