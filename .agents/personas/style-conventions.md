...
- Changesets that include frozen deprecated packages (`bundler-sdk-viem`, `migration-sdk-viem`, `simulation-sdk`, `blue-sdk-wagmi`, `simulation-sdk-wagmi`) outside PRs explicitly scoped to deprecation metadata or source deletion.
