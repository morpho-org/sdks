...
|---|--------------------------------------------------------|---------------------|-----|-----|-----------|--------|
| 1 | fix(morpho-sdk): pin BlueBundlesV1 ABI (+ morpho-ts address) | morpho-sdk · patch | 1 | 2 | —      | #3,#4  |
...
|-----------|---------------------------------------------------|-----------|-----------|
| SDK-101   | fix(morpho-sdk): pin BlueBundlesV1 ABI (+ morpho-ts address) | Train A | — |
