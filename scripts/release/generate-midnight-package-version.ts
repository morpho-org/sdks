...
import { isPathInside } from "./helpers.ts";
 ...
 * @returns Generated TypeScript source.
 */
export function getMidnightPackageVersionSource(
  options: { cwd?: string } = {},
): string {
 ...
 * @returns Generated TypeScript source.
 */
export function generateMidnightPackageVersion(
  options: { cwd?: string } = {},
): string {
  const basePath = realpathSync(options.cwd ?? DEFAULT_REPOSITORY_ROOT);
